                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{route('brand.edit', $brand->id)}}" data-toggle="tooltip" title="Edit"
                                    ...
                                    <form class="d-inline" action="{{route('brand.destroy', $brand->id)}}" method="post">
                                        ...
                                        <button class="btn btn-hover-shine btn-outline-danger border-0 btn-sm"
                                            ...
                                            onclick="return confirm('Nếu xóa thương hiệu này các sản phẩm thuộc thương hiệu cũng sẽ bị xóa? Bạn chắc chắn muốn xóa?')">
                                            <span class="btn-icon-wrapper opacity-8">
