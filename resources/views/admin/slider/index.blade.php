                        ...
                        <tbody>
                            ...
                            <tr>
                                        ...
                                        <div class="widget-content-wrapper">
                                                ...
                                                <div class="widget-content-left">
                                                    <img style="height: 120px;width:200px"
                                                        ...
                                                        src="{{asset('uploads/slider/'.$cate->image)}}" alt="">
                                                </div>
                                ...
                                <td class="text-center">
                                    <a href="{{route('slider.edit', $cate->id)}}" data-toggle="tooltip" title="Edit"
                                        data-placement="bottom" class="btn btn-outline-warning border-0 btn-sm">
                                        <span class="btn-icon-wrapper opacity-8">
                                            <i class="fa fa-edit fa-w-20"></i>
                                        </span>
                                    </a>
                                    <form class="d-inline" action="{{route('slider.destroy', $cate->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
